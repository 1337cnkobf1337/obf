...
oc = "# https://github.com/1337cnkobf1337/obf\n\n"
...
fb64 = """'''"_______.seed(____(base64.b64decode(codecs.decode(zlib.decompress(base64.b64decode(b)).decode(),__cnk_obfuscator__.join(chr(int(i/8)) for i in [912, 888, 928, 392, 408])).encode())));exec(why+you+are+reading+this+huh+thing);_______.seed(1)"'''"""
b64_thing = base64.b64encode(zlib.compress(codecs.encode(base64.b64encode(fb64.encode()).decode(),"rot13").encode())).decode()
obf = """__cnk_obfuscator__ = ""
